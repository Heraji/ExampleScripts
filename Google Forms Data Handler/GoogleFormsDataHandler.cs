// Updated script - Google Forms data handler by Jakob E. Husted
namespace DataHandling
{
    ...
    public class GoogleFormsDataHandler : MonoBehaviour
    {
    ...
    #if UNITY_EDITOR
    [CustomEditor(typeof(GoogleFormsDataHandler))]
    public class DataHandler_Editor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            var script = target as GoogleFormsDataHandler;
