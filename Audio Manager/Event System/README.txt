(This event system was not made by me)
This event system is used for calling the audio manager, but is based on a mix of GDC talks and YT videos on scriptable object events.
